...
export async function getProjectsbyID(id){
    const response = await axios.get(`${baseUrl}/${id}?t=${new Date().getTime()}`)
    return response.data
}

export async function getProjectMember(id){
    const response = await axios.get(`${baseUrl}/${id}/members?t=${new Date().getTime()}`)
    return response.data
}

export async function getProjectTask(id){
    const response = await axios.get(`${baseUrl}/${id}/tasks?t=${new Date().getTime()}`)
    return response.data
}

export async function getProjectTaskbySprint(id){
    const response = await axios.get(`${baseUrl}/${id}/tasks/by-sprint?t=${new Date().getTime()}`)
    return response.data
}

export async function getProjectSprint(id){
    const response = await axios.get(`${baseUrl}/${id}/sprints?t=${new Date().getTime()}`)
    return response.data
}

export async function getProjectSprintbyID(id1,id2){
    const response = await axios.get(`${baseUrl}/${id1}/sprints/${id2}?t=${new Date().getTime()}`)
    return response.data
}
